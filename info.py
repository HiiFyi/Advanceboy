...
API_ID = int(environ['21430084'])
API_HASH = environ['1e849094b8a8dcdfd8944c23172f09b7']
BOT_TOKEN = environ['8152209761:AAHtAJGsAQj8B9R2EKv0MRxj_j4NjPX6wu4']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002637635533').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002563673838').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "jc13914")
DATABASE_NAME = environ.get('DATABASE_NAME', "mongodb+srv://jc13914:<db_password>@cluster0.ew27i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002590055293'))
REQ_CHANNEL = int(environ.get('REQ_CHANNEL','-1002501085141'))
PRIME_MEMBERS_LOGS = int(environ.get('PRIME_MEMBERS_LOGS','-1002580278009'))

# PREMIUM ACCESS *
lazydownloaders = [int(lazydownloaders) if id_pattern.search(lazydownloaders) else lazydownloaders for lazydownloaders in environ.get('PRIME_DOWNLOADERS', '-1002547558912').split()]
PRIME_USERS = (lazydownloaders) if lazydownloaders else [] # users who can get & download file without url shortner
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '7759711077').split()]

QR_CODE_IMG = environ.get('QR_CODE_IMG','na') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', 'not available') #enter your upi id here - grab it from your online payment methods.
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','J_C_13914') # WITHOUT @
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "https://t.me/+rQXyFm0x2JVjMzll") #[ without @ ]
...
my_users = [int(my_users) if id_pattern.search(my_users) else my_users for my_users in environ.get('MY_USERS', '-1002590055293').split()]
